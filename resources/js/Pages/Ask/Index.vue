                    ...
                    <form @submit.prevent="sendMessage" class="max-w-3xl mx-auto">
                        <div class="flex space-x-4">
                            ...
                            <button
                                ...
                                class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-7focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
